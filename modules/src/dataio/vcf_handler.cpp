...
map<long long, vector<type_vcf_record> > vcf_handler::get_positional_vcf_records(string chromosome_name,
                                                                                 long long start,
                                                                                 long long stop) {
    map<long long, vector<type_vcf_record> > positional_vcf_records;
